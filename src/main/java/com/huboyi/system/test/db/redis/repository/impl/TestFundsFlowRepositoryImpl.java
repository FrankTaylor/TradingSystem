 ...
 * @version 1.0
 */
public class TestFundsFlowRepositoryImpl extends RedisTemplate<String, FundsFlowPO> implements TestFundsFlowRepository {
	...
	public void insert(FundsFlowPO po) {
		...
		try {
			...
			// --- 把记录保存到Redis。
			po.setId(UUID.randomUUID().toString() + "-" + TestFundsFlowRepository.class.getName());
