...
public class PositionFunction {
	 ...
	 */
	public static PositionInfoBean getLastNoClosePosition (List<PositionInfoBean> positionInfoList, DealSignalEnum dealSignalType) {
	 ...
	 * @return List<PositionInfoBean>
	 */
	public static PositionInfoBean getLastClosePosition (List<PositionInfoBean> positionInfoList, DealSignalEnum dealSignalType) {
	 ...
	 * @return List<PositionInfoBean>
	 */
	public static List<PositionInfoBean> getAllNoClosePositionList (List<PositionInfoBean> positionInfoList, DealSignalEnum dealSignalType) {
	 ...
	 * @return List<PositionInfoBean>
	 */
	public static List<PositionInfoBean> getAllClosePositionList (List<PositionInfoBean> positionInfoList, DealSignalEnum dealSignalType) {
	 ...
	 * @return List<PositionInfoBean>
	 */
	public static List<PositionInfoBean> getAllPositionList (List<PositionInfoBean> positionInfoList, DealSignalEnum dealSignalType) {
		// 把符合买点的仓位信息装载到集合中。
