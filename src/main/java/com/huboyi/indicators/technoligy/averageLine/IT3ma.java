 ...
 * 三重指数移动平均。
 *
 * Created by hubin3 on 2016/8/16.
 */
public class IT3ma implements Ma {
     ...
     * @param num 取值个数
     */
    public IT3ma(IStatistics statistics, Period period, IStatisticsDataType dataType, int step, double factor, int num) {
     ...
     * @param num 取值个数
     */
    public IT3ma(Double[] vs, int step, double factor, int num) { this(vs, step, factor, num, DEFAULT_SCALE); }
     ...
     * @param scale 精度
     */
    public IT3ma(Double[] vs, int step, double factor, int num, int scale) {
